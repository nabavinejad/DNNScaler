...
def getResnet50():
  with gfile.FastGFile("frozen_inception_v3.pb",'rb') as f:
...
if "__main__" in __name__:
  ...
  if f.native:
    ...
    if os.path.exists('runtimes_InceptionV3_BatchScaler.txt'):
        append_write = 'a'  # append if already exists
    else:
        append_write = 'w'  # make a new file if not

    runtimeResults = open('runtimes_InceptionV3_BatchScaler.txt', append_write)
