...
def getResnet50():
  with gfile.FastGFile("mobilenet_v2_1.4_224_frozen.pb",'rb') as f:
...
if "__main__" in __name__:
  ...
  if f.native:
    ...
    if os.path.exists('runtimes_MobilenetV2_14_MT.txt'):
        append_write = 'a'  # append if already exists
    else:
        append_write = 'w'  # make a new file if not

    runtimeResults = open('runtimes_MobilenetV2_14_MT.txt', append_write)
