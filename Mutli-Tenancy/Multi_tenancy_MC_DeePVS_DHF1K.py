...
def main(result_DNNScaler, DNN, ExpectedLatency, biasStep):
    ...
    MC_Estimations = [977.00, 1145.59, 1361.71, 1844.46, 2059.83, 2402.70, 2944.18, 3780.98, 4053.43, 4344.19]
    ...
    for k in range(temp):
        DNN_ID = k + 1
        os.system("python DeePVS_DNNScaler.py --batch_size 1 --input_video \"DHF1K.mp4\"  --job_id " + str(DNN_ID) + "  &")
